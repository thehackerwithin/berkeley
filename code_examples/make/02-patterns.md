...
We'd also like to figure out what to do about `thw_icon.eps` and the files it depends on.
The rules are exactly the same as those for `graph.eps` and its prerequisites;
