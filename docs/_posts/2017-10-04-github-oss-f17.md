...
GitHub is an ideal tool for open source projects for many reasons. It's free for open source projects. The pull request and review tools make contributing to open source much easier. And other tools like automatic detection of licenses, contribution guidelines, codes of conduct and issue or pull request templates are also very useful.
...
### Pull Requests
Pull requests are one of the most useful keys to contributing to open source.
