...
**Example:** Let's look through [Doxygen's Python commenting](http://www.stack.n
l/~dimitri/doxygen/manual/docblocks.html#pythonblocks)

###Example

Let's look at multilevel_solver.py and use doxygen to build documentation. Type:

    > doxygen -g example_doc

This will create a Doxygen configuration file that gives Doxygen directions.
Open this file and go to INPUT. Add

    "multilevel_solver.py"

Other items we could change right away: OPTIMIZE_OUTPUT_JAVA; PROJECT_NAME
...
Next, let's add input and output descriptions to a function and see what
happens.
...
[README](https://www.kernel.org/pub/linux/kernel/README)
>
